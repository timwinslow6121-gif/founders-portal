...
- 🔜 NEXT: **S3 — Encryption-at-rest** (Milestone 1 / Security pillar 4; see [[s3-encryption-preview]] — FIRST task = verify VPS disk encryption; then searchable-MBI column encryption). Then S4 pentest. Then Milestone 2 (UI/IA), Milestone 3 (#6 names).
