...
# CMS max broker rates (NC/SC = "all other states")
# Source: https://ritterim.com/blog/2026-maximum-broker-commissions-for-medicare-advantage-and-medicare-part-d/
MAPD_INIT_2026   = 57.83   # $694/yr ÷ 12
MAPD_RENEW_2026  = 28.92   # $347/yr ÷ 12
MAPD_INIT_2025   = 52.17   # $626/yr ÷ 12
MAPD_RENEW_2025  = 26.08   # $313/yr ÷ 12
PDP_INIT_2026    = 9.50    # $114/yr ÷ 12
PDP_RENEW_2026   = 4.75    # $57/yr ÷ 12
...
PLANS = [
    ...
    dict(
        ...
        monthly_premium=0.0,
        comm_type="pmpm", comm_initial=MAPD_INIT_2026, comm_renewal=MAPD_RENEW_2026,
    ...
    dict(
        ...
        comm_type="pmpm", comm_initial=PDP_INIT_2026, comm_renewal=PDP_RENEW_2026,
        is_commissionable=True,
